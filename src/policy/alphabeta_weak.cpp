...
#include "./alphabeta_weak.hpp"


/**
 * @brief get a legal action by alphabeta_weak
 * 
 * @param state Now state
 * @param depth 
 * @return Move 
 */
Move Alphabeta_weak::get_move(State *state, int depth, int player){
...
*/
int Alphabeta_weak::get_value(State *state, int depth, int player, int alpha, int beta){
  int value;
